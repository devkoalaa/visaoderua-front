  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 -bottom-px h-16 bg-gradient-to-t from-asphalt-800 via-asphalt-800/60 to-transparent" aria-hidden />
      ...
      <div className="relative -mt-px flex flex-1 flex-col gap-3 bg-asphalt-800 p-4">
